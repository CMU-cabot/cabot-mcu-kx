...
#define CAN_FILTER0   0x01080000  // 0b0 010 0001 000 filter for ADDR_ODRIVE ~ ADDR_PWM (major=2, minor=1)
#define CAN_FILTER1   0x07ff0000  // 0b1 111 1111 111 disable filter
#define CAN_MASK0     0x07f80000  // 0b1 111 1111 000 mask by priority, major, minor
#define CAN_MASK1     0x00000000  // 0b0 000 0000 000 disable filter
